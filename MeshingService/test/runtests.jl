...
# !!! Main.UserApp is configured as an alias for Main.MeshingService and you might encounter it in some tests
using Main.MeshingService, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "MeshingService tests" begin
  @includetests ARGS
end
