...
# !!! Main.UserApp is configured as an alias for Main.Backend and you might encounter it in some tests
using Main.Backend, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Backend tests" begin
  @includetests ARGS
end
